...
def prefilter_items(data, take_n_popular=5000, item_features=None):
    ...
    if item_features is not None:
        ...
        data.loc[data['item_id'].isin(items_in_rare_departments), 'item_id'] = 999999
    ...
    top = set(popularity.sort_values('n_sold', ascending=False).head(take_n_popular + 1).item_id.tolist())
    top.remove(999999)
